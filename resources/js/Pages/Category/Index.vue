            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    <form @submit.prevent="createCategory" class="space-y-4">
                        ...
                        <button
                            type="submit"
                            class="inline-flex items-center px-4 py-2 bg-oficial border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-oficial focus:outline-none focus:ring focus:ring-indigo-200 active:bg-oficial disabled:opacity-25 transition"
                        >
                            Save
                        </button>
                    </form>
